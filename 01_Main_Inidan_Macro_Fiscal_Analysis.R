...
set.seed(139)
install.packages("urca")   #package for zivot-andrews unit root test
install.packages("meboot") #package for maximum entropy bootstrap 
install.packages("philentropy") #package for Jensen-Shannon Divergence Calculation
library(meboot) 
library(urca)
library(philentropy)
